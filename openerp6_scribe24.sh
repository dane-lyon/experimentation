...
#### script pour installer OpenERP v6 sur un scribe 2.4 #######
...
#version plus récente (Odoo 8). 

#### DANE rectorat de lyon ######
#### Simon B, Dominique J, Jean-Philippe.P ####

# Script modifié par Simon.B avec l'aide de Karim.A
...
# OU le mettre manuellement sur le serveur, voir fichier ici : https://github.com/dane-lyon/experimentation/blob/master/dico_dane.xml
...
#	echo
#fi
#exit 0 " > /usr/share/eole/diagnose/151-openerp
#chmod +x /usr/share/eole/diagnose/151-openerp
...
echo "30 23 * * * root /etc/init.d/postgresql restart" > /etc/cron.d/openerp_restart
...
mkdir /home/openerp_base
mv /var/lib/postgresql/9.1/main/base /home/openerp_base
ln -s /home/openerp_base/base /var/lib/postgresql/9.1/main/base
chown -R postgres:postgres /home/openerp_base
chmod -R u=rwx /home/openerp_base
